...
/**
 *
 * @author Christopher Church/Reese Childers
 */
public class OverviewPanel extends JTabbedPane{
    ...
    */
    ...
    public OverviewPanel(){
        ...
        overPanel.setBackground(COLOR_OVER);
    ...
    private void assemblePanel(){
        ...
        overPanel.add(ColorPanel,cons);
        cons.gridy++;
        setInfoConstraints(cons);
        cons.ipadx = 5;
        overPanel.add(ClassNameLabel,cons);
        cons.gridx++;
        overPanel.add(TakenCheckBox, cons);
        cons.gridy++;
        cons.gridx--;
        overPanel.add(CreditHoursLabel, cons);
        cons.gridx++;
        overPanel.add(CreditHourTextField, cons);
        cons.gridy++;
        cons.gridx--;
        overPanel.add(OfferedLabel, cons);
        cons.gridx++;
        overPanel.add(OfferedTextField, cons);
        cons.gridy++;
        cons.gridx--;
        
        changeFont(overPanel, CourseFont);
        add("Overview", overPanel);
		...
		*/
        ...
        overPanel.setMaximumSize(new Dimension(400,400));
